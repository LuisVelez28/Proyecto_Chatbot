...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        @foreach ($productos as $producto)
                ...
                @php
                    $sabor = collect($tipos_sabores)
                        ->where('id', $producto->id_sabor)
                        ->first()->nombre;
                    $rangoPrecio= collect($rangos_precios)
                        ->where('id', $producto->id_rango_precio)
                        ->first()->nombre;
                    $tipo= collect($tipos_productos)
                        ->where('id', $producto->id_tipo_producto)
                        ->first()->nombre;
                @endphp
